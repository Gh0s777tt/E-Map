...
> Stan: **v1.40.0** · Expo SDK 56 · React Native 0.85 (New Architecture) · zsynchronizowane z v1.139.0 (#286) · 2026-07-11 · **iOS w recenzji Apple (Waiting for Review)** (ASC App ID 6789726653)
