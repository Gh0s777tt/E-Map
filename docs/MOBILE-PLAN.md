...
> Stan: **v1.58.0** · Expo SDK 56 · React Native 0.85 (New Architecture) · zsynchronizowane z v1.165.0 (#312) · 2026-07-13 · **iOS w recenzji Apple** (ASC App ID 6789726653) · **Android w testach wewnętrznych Google Play** (com.ghostempire.elogistic)
