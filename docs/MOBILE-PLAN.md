...
> Stan: **v1.77.0** · Expo SDK 56 · React Native 0.85 (New Architecture) · zsynchronizowane z v1.190.0 (#345) · 2026-07-14 · **iOS w recenzji Apple** (ASC App ID 6789726653) · **Android w testach wewnętrznych Google Play** (com.ghostempire.elogistic)
