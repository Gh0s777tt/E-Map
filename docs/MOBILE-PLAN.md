...
> Stan: **v1.90.1** · Expo SDK 56 · React Native 0.85 (New Architecture) · zsynchronizowane z v1.207.0 (#363) · 2026-07-19 · **iOS w TestFlight** (build 47 VALID, ASC App ID 6789726653) · **Android w teście zamkniętym Google Play** (alpha, com.ghostempire.elogistic)
