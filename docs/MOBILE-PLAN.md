...
> Stan: **v1.56.0** · Expo SDK 56 · React Native 0.85 (New Architecture) · zsynchronizowane z v1.162.0 (#309) · 2026-07-12 · **iOS w recenzji Apple (Waiting for Review)** (ASC App ID 6789726653)
