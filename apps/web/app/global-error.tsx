 ...
 * więc globalny handler (#306) tych crashy nie widział. `lang` zostaje „pl", bo treść tego
 * ekranu jest zaszyta po polsku (i18n tu nie sięga — komponent zastępuje root layout).
 */
