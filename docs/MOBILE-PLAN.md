...
> Stan: **v1.38.0** · Expo SDK 56 · React Native 0.85 (New Architecture) · zsynchronizowane z v1.137.0 (#284) · 2026-07-11 · **iOS w recenzji Apple (Waiting for Review)** (ASC App ID 6789726653)
