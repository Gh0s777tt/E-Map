...
> Stan: **v1.90.0** · Expo SDK 56 · React Native 0.85 (New Architecture) · zsynchronizowane z v1.206.0 (#362) · 2026-07-19 · **iOS w TestFlight** (build 47 VALID, ASC App ID 6789726653) · **Android w teście zamkniętym Google Play** (alpha, com.ghostempire.elogistic)
