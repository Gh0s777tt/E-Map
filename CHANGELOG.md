...
- `[#359]` ⏱ **C — WTD 2002/15/WE** ([tachoTime.ts](packages/core/src/tachoTime.ts)) — reżim **ODRĘBNY** od 561: średnia tygodniowa ≤ 48 h w okresie rozliczeniowym (dom. 17 tyg.), maksimum 60 h w tygodniu, praca nocna ≤ 10 h/dobę; budżet „ile godzin do utrzymania średniej 48". Nowe: `WTD_LIMITS`, `wtdStatus()`, `weeklyWorkingFromEntries()`, `isoWeekKey()`.
