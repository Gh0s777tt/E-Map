...
function RootNav() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="manage-vehicles" options={{ title: t("m.screen.manageVehicles") }} />
      <Stack.Screen name="manage-cards" options={{ title: t("m.screen.manageCards") }} />
      <Stack.Screen name="manage-checklists" options={{ title: t("m.screen.manageChecklists") }} />
      <Stack.Screen
      ...
      <Stack.Screen name="manage-drivers" options={{ title: t("m.screen.manageDrivers") }} />
      <Stack.Screen name="manage-service" options={{ title: t("m.screen.manageService") }} />
      <Stack.Screen name="manage-team" options={{ title: t("m.screen.manageTeam") }} />
      <Stack.Screen name="manage-orders" options={{ title: t("m.screen.manageOrders") }} />
      <Stack.Screen name="manage-invoices" options={{ title: t("m.screen.manageInvoices") }} />
