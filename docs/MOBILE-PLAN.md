...
> Stan: **v1.81.0** · Expo SDK 56 · React Native 0.85 (New Architecture) · zsynchronizowane z v1.194.0 (#349) · 2026-07-14 · **iOS w TestFlight** (build 47 VALID, ASC App ID 6789726653) · **Android w testach wewnętrznych Google Play** (com.ghostempire.elogistic)
